...
const styles = StyleSheet.create({
  ...
  header: { paddingHorizontal: 18, paddingVertical: 20, borderBottomWidth: 1 },
  headerRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 12 },
  iconButton: { width: 40, height: 40, borderRadius: 20, justifyContent: 'center', alignItems: 'center' },
  headerTitleWrap: { flex: 1, paddingHorizontal: 4 },
  headerActions: { flexDirection: 'row', gap: 10 },
  headerTitle: { flex: 1, fontSize: 22, fontWeight: '900', textAlign: 'center', textTransform: 'uppercase', letterSpacing: -0.2 },
