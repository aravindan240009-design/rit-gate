                ...
                <>
                  <View style={[styles.controlCard, { backgroundColor: theme.surface, borderColor: theme.border }]}>
                    ...
                    <View style={styles.segmentedTabs}>
                      <TouchableOpacity 
                        style={[styles.segmentTab, activeTab === 'PENDING' && { backgroundColor: theme.primary + '15' }]} 
                        onPress={() => setActiveTab('PENDING')}
                      >
                        <ThemedText style={[styles.segmentLabel, { color: theme.textSecondary }, activeTab === 'PENDING' && { color: theme.primary, fontWeight: '800' }]}>
                          PENDING
                        </ThemedText>
                        <View style={[styles.segmentCountBadge, { backgroundColor: theme.primary + '20' }, activeTab === 'PENDING' && { backgroundColor: theme.primary }]}>
