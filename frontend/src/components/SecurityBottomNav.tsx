...
const SecurityBottomNav: React.FC<SecurityBottomNavProps> = ({ activeTab, onNavigate }) => {
  ...
  return (
    <View style={[styles.bottomTabBar, { backgroundColor: theme.surface, borderTopColor: theme.border, paddingBottom: insets.bottom + 8 }]}>
      <TouchableOpacity style={styles.bottomTab} onPress={() => handleNavigate('home')} activeOpacity={0.7}>
        <Ionicons name={activeTab === 'home' ? 'home' : 'home-outline'} size={22} color={activeTab === 'home' ? theme.primary : theme.textTertiary} />
      ...
      <TouchableOpacity style={styles.bottomTab} onPress={() => handleNavigate('scanner')} activeOpacity={0.7}>
        <Ionicons name={activeTab === 'scanner' ? 'qr-code' : 'qr-code-outline'} size={22} color={activeTab === 'scanner' ? theme.primary : theme.textTertiary} />
      ...
      <TouchableOpacity style={styles.bottomTab} onPress={() => handleNavigate('history')} activeOpacity={0.7}>
        <Ionicons name={activeTab === 'history' ? 'time' : 'time-outline'} size={22} color={activeTab === 'history' ? theme.primary : theme.textTertiary} />
      ...
      <TouchableOpacity style={styles.bottomTab} onPress={() => handleNavigate('vehicle')} activeOpacity={0.7}>
        <Ionicons name={activeTab === 'vehicle' ? 'car' : 'car-outline'} size={22} color={activeTab === 'vehicle' ? theme.primary : theme.textTertiary} />
      ...
      <TouchableOpacity style={styles.bottomTab} onPress={() => handleNavigate('visitor')} activeOpacity={0.7}>
        <Ionicons name={activeTab === 'visitor' ? 'people' : 'people-outline'} size={22} color={activeTab === 'visitor' ? theme.primary : theme.textTertiary} />
      ...
      <TouchableOpacity style={styles.bottomTab} onPress={() => handleNavigate('hods')} activeOpacity={0.7}>
        <Ionicons name={activeTab === 'contacts' ? 'call' : 'call-outline'} size={22} color={activeTab === 'contacts' ? theme.primary : theme.textTertiary} />
